...
from .views import (
    ...
    crear_hecho_criminal,
    editar_hecho_criminal,
    eliminar_hecho_criminal,
...
urlpatterns = [
    ...
    path(
        "hechos/criminales/crear/",
        crear_hecho_criminal,
        name="crear_hecho_criminal",
    ),
    path(
        "hechos/criminales/<int:id>/editar/",
        editar_hecho_criminal,
        name="editar_hecho_criminal",
    ),
    path(
        "hechos/criminales/<int:id>/eliminar/",
        eliminar_hecho_criminal,
        name="eliminar_hecho_criminal",
    ),
